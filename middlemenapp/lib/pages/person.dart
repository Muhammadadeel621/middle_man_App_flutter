          ...
          children: <Widget>[
            ...
            const Row(
              ...
              children: [
                ...
                FaIcon(FontAwesomeIcons.whatsapp, color: CustomColors.bgColor),

                FaIcon(FontAwesomeIcons.github, color: CustomColors.bgColor),
                FaIcon(FontAwesomeIcons.linkedin, color: CustomColors.bgColor),
              ],
            )
          ],
        ),
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const MIddlemanScreen()));
                      },
                      child: const Icon(
                        Icons.more_vert,
                        color: Color(0xff7B7B7B),
